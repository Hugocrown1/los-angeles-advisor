...
const AttractionCard = ({ attraction }) => {
  ...
  return (
    <article
      key={_id}
      className="w-full border-[1px] h-full rounded-lg px-2 py-2 border-[#0018454f] text-left"
    >
      <Link
      ...
      >
        ...
        <div className="primary-button self-baseline bg-[#001845] text-white w-full flex items-center justify-center mt-4">
          Más información
        </div>
      </Link>
    </article>
